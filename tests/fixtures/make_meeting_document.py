...
LINES = [
    ...
    "- Emmental : fromage à pâte pressée cuite (graphie « Emmental »,",
    "  pas « émental »).",
    "- Comté : fromage AOP du massif du Jura (Franche-Comté), à pâte",
    "  pressée cuite. Comté d'été affiné 8 mois ; vieux Comté affiné 24 mois.",
