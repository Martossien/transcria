...
**Version actuelle : 0.3.9.1** ([releases](https://github.com/Martossien/transcria/releases) ·
...
| **SRT locuteurs une passe (MOSS)** | Sous-titres attribués, zéro étape wizard | Une passe MOSS (opt-in, réunions courtes — gardé contre les omissions silencieuses) |
