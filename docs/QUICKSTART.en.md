...
GPU (compute capability ≥ 7.5; **from 8 GB VRAM** — native and Docker slim alike;
the bundled image, which bakes a larger LLM, needs **≥ 12 GB** — and even **without a GPU**: CPU transcription via the Kroko engine, no
