...
| `e4d542a` / `224919e` | Campagne de charge close : split robuste jusqu'a 8 jobs serveur, sweet spot environ 4 sur le banc teste | `docs/archive/PLAN_TEST_CHARGE.md`, `docs/SERVICE_RESSOURCES_GPU.md`, `config.split.example.yaml`, scripts de charge | Les profils doivent etre testes en rafales mixtes et conserver le batching STT/LLM distant |
