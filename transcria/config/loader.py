...
_DEFAULT_CONFIG = {
    ...
    "kroko": {
        "enabled": False,
        "model_dir": "./models/kroko",
        "repo_id": "Banafo/Kroko-ASR",
        "variant": "128",
        "num_threads": 8,
        "decoding_method": "greedy_search",
        "tail_padding_s": 0.66,
        "segment_max_gap_s": 0.8,
        "segment_max_len_s": 15.0,
        "collapse_repetition_loops": True,
        "repetition_loop_min_repeats": 4,
        "repetition_loop_max_phrase_words": 10,
        "repetition_loop_keep_repeats": 2,
