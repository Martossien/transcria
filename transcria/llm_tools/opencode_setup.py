...
Rangé ici (chantier du 2026-07-30) : la moitié ENDPOINT du module historique
``gpu/opencode_setup`` vit désormais dans ``gpu/arbitrage_endpoint`` (vraie dépendance
GPU) ; ce module ne garde que l'outillage opencode (binaire + opencode.json).
"""
