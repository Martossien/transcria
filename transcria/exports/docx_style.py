...
_DOCX_LABELS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        # Un identifiant de diarisation n'est pas un nom : le rendu le présente en clair.
        "speaker_n": "Locuteur {n}",
        "th_role": "Rôle", "th_speaking_time": "Tps de parole",
        "th_turns": "Interventions", "quality": "Fiabilité",
    ...
    "en": {
        ...
        "th_turns": "Turns", "quality": "Reliability",
    ...
    "es": {
        "banner": "ACTA DE TRANSCRIPCIÓN",
        "generated_by": "Generado por TranscrIA",
        "date": "Fecha",
        "duration": "Duración",
        "type": "Tipo",
        ...
        "topic": "Tema",
        "objective": "Objetivo",
        "notes": "Notas / Orden del día",
        "sec_context": "Contexto de la reunión",
        "synthese": "Resumen",
        "summary_stale_note":
            "⚠ El resumen es anterior a la última edición de la transcripción — resincronícelo desde el editor para "
            "reflejar las correcciones.",
        "sec_specific": "Información específica",
        "sec_participants": "Participantes e interlocutores",
        "sec_transcription": "Transcripción",
        "sec_review": "Puntos por revisar",
        "no_participants": "No se ha registrado ningún participante.",
        "no_transcription": "No hay transcripción disponible.",
        "next_meeting": "Próxima reunión: ",
        "sd_agenda": "Orden del día",
        "sd_decisions": "Decisiones tomadas",
        "sd_votes": "Votaciones",
        "sd_resolutions": "Resoluciones adoptadas",
        "sd_actions": "Acciones pendientes",
        "sd_blockers": "Puntos de bloqueo",
        "sd_deferred": "Puntos aplazados",
        "th_name": "Nombre",
        "speaker_n": "Interlocutor {n}",
        "th_function": "Función",
        "th_service": "Departamento",
        "th_role": "Rol",
        "th_speaking_time": "Tiempo de palabra",
        "th_turns": "Intervenciones",
        "quality": "Fiabilidad",
        "badge_crise": "⚠  SITUACIÓN DE CRISIS  ⚠",
        "badge_confidentiel": "▪  DOCUMENTO CONFIDENCIAL  ▪",
        "q_coverage": "⚠  Cobertura de audio",
        "q_relisten": "🔍  Zona por reescuchar",
        "q_term_validate": "✎  Término por validar",
        "q_spelling": "✎  Ortografía por verificar",
        "q_altered_name": "⚠  Nombre de interlocutor alterado",
        "q_missing_term": "✎  Término del léxico no aplicado",
        "q_unmapped": "⚠  Interlocutores no identificados",
        "q_foreign": "🔍  Segmentos en idioma extranjero",
        "q_non_latin": "🔍  Caracteres no latinos",
        "q_anomaly": "anomalía",
        "d_coverage": "{pct}% — posible pérdida de transcripción",
        "d_term_validate": "{term} (variante: {variant})",
        "d_spelling": "{form} similar a {term}",
        "d_altered_name": "{sid}: «{found}» en lugar de «{expected}»",
        "d_missing_term": "«{term}» no encontrado en la transcripción corregida",
        "d_unmapped": "{count} segmento(s) sin participante asociado",
        "d_foreign": "{count} segmento(s) marcado(s) — probable alucinación del ASR o zona con ruido",
        "d_non_latin": "{count} segmento(s) — zonas por reescuchar",
        "d_generic_count": "{count} elemento(s) afectado(s)",
        "d_generic_details": "detalles en quality_report.md",
        "chk_empty_segments": "Segmentos vacíos",
        "chk_short_segments": "Segmentos muy cortos",
        "chk_long_segments": "Segmentos muy largos",
        "chk_overlaps": "Solapamientos de voz",
        "chk_audio_preflight_flags": "Alertas de calidad de audio",
        "chk_suspect_no_speech_prob": "Segmentos con baja probabilidad de voz",
        "chk_suspicious_short_segments": "Segmentos cortos sospechosos",
        "quorum": "Quorum",
        "quorum_reached": "✓ Quorum alcanzado",
        "quorum_not_reached": "✗ Quorum no alcanzado",
        "odj_prefix": "Orden del día",
    },
    "it": {
        "banner": "VERBALE DI TRASCRIZIONE",
        "generated_by": "Generato da TranscrIA",
        "date": "Data",
        "duration": "Durata",
        "type": "Tipo",
        "service": "Reparto",
        ...
        "topic": "Argomento",
        "objective": "Obiettivo",
        "notes": "Note / Ordine del giorno",
        "sec_context": "Contesto della riunione",
        "synthese": "Sintesi",
        "summary_stale_note":
            "⚠ Sintesi antecedente all'ultima modifica della trascrizione — risincronizzare dall'editor per riflettere le "
            "correzioni.",
        "sec_specific": "Informazioni specifiche",
        "sec_participants": "Partecipanti & Parlanti",
        "sec_transcription": "Trascrizione",
        "sec_review": "Punti da verificare",
        "no_participants": "Nessun partecipante registrato.",
        "no_transcription": "Nessuna trascrizione disponibile.",
        "next_meeting": "Prossima riunione: ",
        "sd_agenda": "Ordine del giorno",
        "sd_decisions": "Decisioni prese",
        "sd_votes": "Voti",
        "sd_resolutions": "Risoluzioni adottate",
        "sd_actions": "Azioni da svolgere",
        "sd_blockers": "Punti bloccanti",
        "sd_deferred": "Punti rinviati",
        "th_name": "Nome",
        "speaker_n": "Interlocutore {n}",
        "th_function": "Funzione",
        "th_service": "Reparto",
        "th_role": "Ruolo",
        "th_speaking_time": "Tempo di parola",
        "th_turns": "Interventi",
        "quality": "Affidabilità",
        "badge_crise": "⚠  SITUAZIONE DI CRISI  ⚠",
        "badge_confidentiel": "▪  DOCUMENTO RISERVATO  ▪",
        "q_coverage": "⚠  Copertura audio",
        "q_relisten": "🔍  Zona da riascoltare",
        "q_term_validate": "✎  Termine da convalidare",
        "q_spelling": "✎  Ortografia da verificare",
        "q_altered_name": "⚠  Nome del parlante alterato",
        "q_missing_term": "✎  Termine del lessico non applicato",
        "q_unmapped": "⚠  Parlanti non identificati",
        "q_foreign": "🔍  Segmenti in lingua straniera",
        "q_non_latin": "🔍  Caratteri non latini",
        "q_anomaly": "anomalia",
        "d_coverage": "{pct}% — possibile perdita di trascrizione",
        "d_term_validate": "{term} (variante: {variant})",
        "d_spelling": "{form} simile a {term}",
        "d_altered_name": "{sid}: «{found}» invece di «{expected}»",
        "d_missing_term": "«{term}» non trovato nella trascrizione corretta",
        "d_unmapped": "{count} segmento/i senza partecipante associato",
        "d_foreign": "{count} segmento/i contrassegnato/i — probabile allucinazione ASR o zona rumorosa",
        "d_non_latin": "{count} segmento/i — zone da riascoltare",
        "d_generic_count": "{count} elemento/i interessato/i",
        "d_generic_details": "dettagli in quality_report.md",
        "chk_empty_segments": "Segmenti vuoti",
        "chk_short_segments": "Segmenti molto brevi",
        "chk_long_segments": "Segmenti molto lunghi",
        "chk_overlaps": "Sovrapposizioni di parola",
        "chk_audio_preflight_flags": "Avvisi di qualità audio",
        "chk_suspect_no_speech_prob": "Segmenti con bassa probabilità di parlato",
        "chk_suspicious_short_segments": "Segmenti brevi sospetti",
        "quorum": "Quorum",
        "quorum_reached": "✓ Quorum raggiunto",
        "quorum_not_reached": "✗ Quorum non raggiunto",
        "odj_prefix": "ODG",
    },
}
